          ...
          <div ref={portfolioContent} className={styles.portfolioContent}>
            ...
            <section id="work" className={styles.work}>
              ...
              <div className={styles.projectGrid}>
                ...
                <div className={styles.project}>
                  ...
                  <p>
                    Full Stack Python Data Visualization Project (February – April 2024)
                    <br />
                    • Created a data visualization tool for Instagram follower insights
                    • 90%+ data accuracy through HTML file pattern recognition
                    • Managed with GitHub, deployed on Vercel, hosted on Cloudflare
                    • Created a User Guide video with 200+ views
                  </p>
                </div>
                ...
                <div className={styles.project}>
                  ...
                  <p>
                    ...
                    • Developed robust online test-tracking system
                    • Applied advanced OOP concepts: inheritance, polymorphism
                ...
                <div className={styles.project}>
                  ...
                  <p>
                    ...
                    <br />
                    • Built social media simulation app
                    • Used vanilla HTML, CSS, and JavaScript
                    • Applied UX design principles
            ...
            <section id="contact" className={styles.contact}>
              ...
              <div className={styles.socialLinks}>
                <a href="https://www.linkedin.com/in/anthony--zhou" target="_blank" rel="noopener noreferrer">LinkedIn</a>
                <a href="https://github.com/developer-az" target="_blank" rel="noopener noreferrer">GitHub</a>
                <a href="https://www.instagram.com/anthonyyzhou" target="_blank" rel="noopener noreferrer">Instagram</a>
              </div>
            </section>
